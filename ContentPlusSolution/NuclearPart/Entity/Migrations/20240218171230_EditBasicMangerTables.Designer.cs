...
namespace Entity.Migrations
{
    ...
    [Migration("20240218171230_EditBasicMangerTables")]
    partial class EditBasicMangerTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entity.AdminSection.Admin", b =>
                {
            ...
            modelBuilder.Entity("Entity.AdminSection.AdminRefreshToken", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Entity.AdminSection.Admin", b =>
                {
                    b.HasOne("Entity.SiteSection.Site", "Site")
                        .WithMany("Admin")
            ...
            modelBuilder.Entity("Entity.AdminSection.AdminRefreshToken", b =>
                {
                    b.HasOne("Entity.AdminSection.Admin", "Admin")
                        .WithMany("AdminRefreshToken")
            ...
            modelBuilder.Entity("Entity.AdminSection.Admin", b =>
                {
                    b.Navigation("AdminRefreshToken");
                });
